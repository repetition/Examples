...
public class AutoCheckText {
    private static final String FILE_PATH = "E:\\compare\\test1.txt";
    private static final String COMPARED_FILE_PATH = "E:\\compare\\test2.txt";
    private static final String RESULT_FILE_PATH = "E:\\compare\\result.txt";
